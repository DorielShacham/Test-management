This test management include the following Word Files:
Test Plans.
Test Cases.
Stakeholders.
Test Segmentations.
...
Test Segmentation - Info regarding programs and app to run the tests
Test Objectives - List and phases of tasks
Test Case - Every step you take during the Test phase(the main test report)
